...
use JLTFLICKR\Libs\Recommended;
	...
	class Recommended_Plugins extends Recommended {
		...
		public function plugins_list() {
			return array(
				...
				'ultimate-blocks-for-gutenberg'                    => array(
					...
					'icon'              => 'https://ps.w.org/ultimate-blocks-for-gutenberg/assets/icon-128x128.png',
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. jewel-flickr-settings /  edit.php?post_type=page .
				__( 'Recommended', 'jewel-flickr' ),
				__( 'Recommended', 'jewel-flickr' ),
				'manage_options',
				'jewel-flickr-recommended-plugins',
